...
const data = [
    {
        ...
        video: {
            type: "src",
            src: "/2019/why-they-can-only-be-silent-to-strangers.mp4",
        },
        division: "talk",
        createTS: "",
        authorID: 1,
        ...
        video: {
            type: "src",
            src: "/2019/how-do-we-need-to-rethink-our-basic-education.mp4",
        },
        division: "talk",
        createTS: "",
        authorID: 0,
        ...
        video: {
            type: "src",
            src: "/2019/feel-the-power-of-the-land-and-self-by-walking.mp4",
        },
        division: "talk",
        createTS: "",
        authorID: 0,
        ...
        video: {
            type: "src",
            src: "/2019/when-creation-becomes-a-habit.mp4",
        },
        division: "talk",
        createTS: "",
        authorID: 0,
        ...
        video: {
            type: "src",
            src: "/2019/reduce-carbon-emissions.mp4",
        },
        division: "talk",
        createTS: "",
        authorID: 0,
        ...
        video: {
            type: "src",
            src: "/2019/the-cave-is-a-planet-without-light.mp4",
        },
        division: "talk",
        createTS: "",
        authorID: 0,
        ...
        video: {
            type: "src",
            src: "/2019/building-city-Developmental-self-contradiction.mp4",
        },
        division: "talk",
        createTS: "",
        authorID: 0,
        ...
        video: {
            type: "src",
            src: "/2019/assembly-line-workers-become-New-York-programmers.mp4",
        },
        division: "talk",
        createTS: "",
        authorID: 0,
        ...
        title: "我们每周会吃下多少塑料？关于无塑化社会的践行 | 雒晓彬",
        ...
        video: {
            type: "src",
            src: "/2019/how-much-plastic-do-we-eat-every-week.mp4",
        },
        division: "talk",
        createTS: "",
        authorID: 0,
        ...
        video: {
            type: "src",
            src: "/2019/help-people-with-disabilities-return-to-life.mp4",
        },
        division: "talk",
        createTS: "",
        authorID: 0,
        ...
        video: {
            type: "src",
            src: "/2019/what-is-the-unique-recipe-for-gourmet-food.mp4",
        },
        division: "talk",
        createTS: "",
        authorID: 0,
...
function videosInit() {
    ...
    for (let i = 0; i < data.length; i++) { // 将src补全
        ...
        if (data[i].video.type == "src") {
            output[i].video.src = ossVideoBaseURL + data[i].video.src;
        }
    }
    return output;
}
